...
import setGridName from './setGridName';
...
class PageList extends React.Component {
    ...
    render(){
        const {className, grid, size, pageSize, total, current, callback, currentItems, ...other} = this.props;
        let cName = '';
        let _this = this;
        if(grid){
        ...
        return (
            <div {...other} className={cName}>
                <span className="mt-allItem">{'共' + Math.ceil(total / pageSize) + '页' + ' / 共' + total + '条'}</span>
                {/* <span className="mt-currentItems"> {'当页' + currentItems + '条'} </span> */}
